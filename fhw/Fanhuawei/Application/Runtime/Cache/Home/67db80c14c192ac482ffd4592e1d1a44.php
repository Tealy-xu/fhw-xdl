...
<title>【华为平板 /穿戴】平板电脑、智能手环 、智能手表- 华为商城_华为商城</title>
<meta name="keywords" content="华为平板电脑报价,华为平板电脑推荐,华为平板电脑怎么样,智能手环怎么样,智能手表报价,">
<meta name="description" content="华为商城是华为旗下面向全国服务的电子商务官网。我们提供最新华为平板电脑推荐大全、华为平板电脑报价、图片和参数等商品信息。品质保证！">

<link href="/fhw/Fanhuawei/Public/css/ec.core.min.css" rel="stylesheet" type="text/css">
<link href="/fhw/Fanhuawei/Public/css/header.css" rel="stylesheet" type="text/css">

<link href="/fhw/Fanhuawei/Public/css/catelist.min.css" rel="stylesheet" type="text/css">
...
<script src="/fhw/Fanhuawei/Public/js/jquery-1.10.2.min.js"></script>
<script src="/fhw/Fanhuawei/Public/js/ec.core.js"></script> 
<script src="/fhw/Fanhuawei/Public/js/ec.business.js"></script> 
<!--[if lt IE 9]><script src="http://res.vmallres.com/20160509/js/common/html5shiv.js"></script> <![endif]-->
</head>
...
<div class="hr-10"></div><div class="layout">
  ...
  <div class="pro-cate-area">
    ...
    <div class="pro-cate-attr clearfix">
      ...
      <div class="p-default">
        <ul>
          <li id="first-category" class="allcategory" value="<?php echo ($parents["0"]); ?>"><a href="<?php echo U('catelist/catelist',array('cid'=>$parents[0]));?>">全部</a></li>
      ...
      <div class="p-values">
        <div class="p-operate" style="display: none;">
          ...
          <a href="javascript:;">更多<s></s></a>
        </div>
        <!-- 一行的高度为30px,显示n行，p-expand的高度为nx30 -->
        <div class="p-expand">
          <ul class="clearfix allcategory">
              <?php if(is_array($categorys)): foreach($categorys as $key=>$v): ?><li value="<?php echo ($v["id"]); ?>"><a href="<?php echo U('catelist/catelist',array('cid'=>$v['id']));?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
          </ul> 
        </div>
      </div>
    ...
    <div class="pro-cate-sort clearfix">
      ...
      <div class="p-default">
        <ul>
          <li id="sort-default" class="" value="id"><a href="<?php echo U('catelist/catelist',array('cid'=>$currentid,'sort'=>'id'));?>">默认</a></li>
        </ul>
      </div>
      <div class="p-values">
        <div class="p-expand">          
          <ul class="clearfix">
            ...
            <li id="sort-price" class="" value="price"><a href="<?php echo U('catelist/catelist',array('cid'=>$currentid,'sort'=>'price','order'=>$order));?>" class="sort-price">价格<s></s></a></li>
            <li id="sort-registterTime" value="addtime"><a href="<?php echo U('catelist/catelist',array('cid'=>$currentid,'sort'=>'addtime','order'=>$order));?>" class="sort-added">上架时间<s></s></a></li>
          </ul>
        </div>
      </div>
  ...
  <!-- 20140726-频道-列表-start -->
    ...
    <div class="pro-list clearfix">
      <ul>
  <?php if(is_array($goodslist)): foreach($goodslist as $key=>$vo): ?><li value="<?php echo ($vo["cateid"]); ?>">
          <div class="pro-panels">
            <p class="p-img"><a target="_blank" href="<?php echo U('detail/particulars',array('goods_id'=>$vo['id']));?>" title="<?php echo ($vo["name"]); ?>"><img src="/fhw/Fanhuawei/Public/<?php echo ($vo["image1"]); ?>"></a></p>
            <p class="p-name"><a target="_blank" href="<?php echo U('detail/particulars',array('goods_id'=>$vo['id']));?>" title="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?><span class="red"></span></a></p>
            <p class="p-price"><b>¥<?php echo ($vo["price"]); ?></b></p>
            <div class="p-button clearfix">
              <table colspan="0" border="0" rowspan="0">
                <tbody>
                  <tr>
                    <td><a target="_blank" href="<?php echo U('detail/particulars',array('goods_id'=>$vo['id']));?>" class="p-button-cart"><span>立即购买</span></a></td>
                    <td><label class="p-button-score"><span>117人评价</span></label></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <s class="p-tag"><img src="/fhw/Fanhuawei/Public/images/1460242398600.png"></s>
          </div>
    ...
    <!-- 20140727-商品列表-end -->
    <!-- 分页-start -->
    <div id="list-pager-113" class="pager">
        <span class="hide">
          <a href="#" title="平板 &amp; 穿戴 第1页">第1页</a>&nbsp;&nbsp;
        </span>
      </div>
...
<script>
    // 判断当前get的字段来选中状态
    $("li[value='<?php echo ($currentid); ?>']").addClass('selected');
    $("li[value='<?php echo ($sort); ?>']").addClass('selected');

    // 没有数据时，显示层
    $(function(){
      if($('.pro-list').find('li').length == 0){
