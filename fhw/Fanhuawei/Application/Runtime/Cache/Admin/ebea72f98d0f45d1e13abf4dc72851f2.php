	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr class="text-c">
					...
					<td class="f-14"><a title="删除" href="javascript:;" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
$('.ml-5').click(function(){
	...
	layer.confirm('确认要删除吗？',function(index){
		$.get(
			'/lamp/Fanhuawei/index.php/Admin/Category/delCate',
			{id : id}
			);
