...
<body>
<div class="pd-20">
	<form action="/lamp/Fanhuawei/index.php/Admin/Blogroll/doAddBlogroll" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-2">链接名称：</label>
			<div class="formControls col-10">
				<input type="text" name="name" id="" placeholder="链接名称" value="" class="input-text" style=" width:25%">
				  </div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>链接地址：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="链接地址" id="" name="url">
			</div>
		</div>
