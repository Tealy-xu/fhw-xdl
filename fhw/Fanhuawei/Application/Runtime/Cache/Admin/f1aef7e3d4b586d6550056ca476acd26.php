...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加资讯" _href="/lamp/Fanhuawei/index.php/Admin/Article/addArticle" onclick="Hui_admin_tab(this)"  ><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<?php if(is_array($articlelist)): foreach($articlelist as $key=>$v): ?><tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td><?php echo ($v["id"]); ?></td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10002')" title="查看"><?php echo ($v["title"]); ?></u></td>
					...
					<?php if($v['status'] == 1): ?><a style="text-decoration:none" onClick="article_yishenhe(this,'10001',<?php echo ($v["id"]); ?>)" href="javascript:;" title="审核">
					已审核
					</a> 
					<?php else: ?>
					...
					<a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','updArticle/id/<?php echo ($v["id"]); ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'10001',<?php echo ($v["id"]); ?>)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
/*资讯-删除*/
function article_del(obj,id,aid){
	layer.confirm('确认要删除吗？',function(index){
		$(obj).parents("tr").remove();
		layer.msg('已删除!',{icon: 5,time:1000});

		$.get(
	    	'/lamp/Fanhuawei/index.php/Admin/Article/updDel', //url
	    	//已发送给服务器的数据
	    	{id: aid},
...
/*资讯-审核*/
function article_shenhe(obj,id,aid){
	layer.confirm('审核文章？', {
		btn: ['通过','不通过'], 
		shade: false
	},
	function(){
		$(obj).parents("tr").find(".td-manage").prepend('<a class="c-primary" style="text-decoration:none;color:black;" onClick="article_yishenhe(this,10001,'+aid+')"  href="javascript:;" title="申请上线">已审核</a>');

		// console.log(aid);
		$.get(
	    	'/lamp/Fanhuawei/index.php/Admin/Article/updStatus', //url
	    	//已发送给服务器的数据
	    	{id: aid},
	...
	function(){
		// $(obj).parents("tr").find(".td-manage").prepend('<a class="c-primary" style="color:black;"   href="javascript:;" title="申请上线">审核</a>');
...
//不发布
function article_yishenhe(obj,id,aid){
	layer.confirm('确认要取消吗？',function(index){
		$(obj).parents("tr").find(".td-manage").prepend('<a class="c-primary" style="color:black;" onClick="article_shenhe(this,10001,'+aid+')" href="javascript:;" title="发布">审核</a>');
		$(obj).parents("tr").find(".td-status").html('<span class="label label-success radius">审核</span>');
		$(obj).remove();
		...
		//ajax post
		$.get(
	    	'/lamp/Fanhuawei/index.php/Admin/Article/updNoStatus', //url
	    	//已发送给服务器的数据
	    	{id: aid},
