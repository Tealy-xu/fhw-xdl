...
<link href="/lamp/Fanhuawei/Public/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<?php echo U('dologin');?>" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          <input class="input-text size-L" name="code" type="text" placeholder="验证码" style="width:220px;">
          <img src="<?php echo U('Login/yzm');?>" alt="" width="130px" height="40px" onclick="this.src='<?php echo U('Login/yzm');?>'"> </div>
      </div>
      <div class="row">
        <div class="formControls col-8 col-offset-3">
...
<div class="footer">Copyright 繁花唯xxxxxxxxxxx</div>
