...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="javascript:;" onclick="product_edit('产品编辑','/lamp/Fanhuawei/index.php/Admin/Admin/roleaddAdmin','10001')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr class="text-c">
				...
				<td class="f-14"><a title="编辑" href="javascript:;" onClick="product_edit('产品编辑','/lamp/Fanhuawei/index.php/Admin/Admin/roleUpdAdmin/role_id/<?php echo ($v["role_id"]); ?>','10001')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'1',<?php echo ($v["role_id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
/*管理员-角色-删除*/
function admin_role_del(obj,id,rid){
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		...
		$.get(
	    	'/lamp/Fanhuawei/index.php/Admin/Admin/delRole', //url
	    	//已发送给服务器的数据
	    	{role_id: rid},
