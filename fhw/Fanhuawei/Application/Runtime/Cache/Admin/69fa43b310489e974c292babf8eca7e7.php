...
<div class="pd-20" style="padding-top:20px;">
  <p class="f-20 text-success">欢迎回来 <?php echo ($user["username"]); ?></p>
  <p>上次登录IP：<?php echo ($user["lastip"]); ?>  上次登录时间：<?php echo (date('Y-m-d H:i:s',$user["lastlogin"])); ?></p>
  <table class="table table-border table-bordered table-bg">
    <thead>
      <tr>
        <th colspan="7" scope="col">近日更新</th>
      </tr>
      <tr class="text-c">
        <th>统计</th>
        <th>资讯库</th>
