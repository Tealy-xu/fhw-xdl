...
<body>
<div class="pd-20">
	<form action="/lamp/Fanhuawei/index.php/Admin/Article/doUpdArticle" method="post" class="form form-horizontal" id="form-article-add">
		<input type="hidden" value="<?php echo ($ainfo["id"]); ?>" name="id">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>文章标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($ainfo["title"]); ?>" placeholder="" id="" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2">
				<input type="text" class="input-text"  placeholder="" value="<?php echo ($ainfo["author"]); ?>" id="" name="author">
			</div>
